...
!    end if
  ...
  call aero_model_strat_surfarea( ncol, mmr, pmid, tfld, troplev, pbuf, strato_sad)
    ...
    !-----------------------------------------------------------------------
    call t_startf('mjs_setrxt')
    call setrxt( reaction_rates, tfld, invariants(1,1,indexm), ncol, lchnk )
    call t_stopf('mjs_setrxt')
