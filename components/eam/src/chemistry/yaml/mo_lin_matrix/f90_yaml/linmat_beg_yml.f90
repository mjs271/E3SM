  ...
  !-----------------------------------------------------------------------------------------
     ...
     !if ((n_calls==1 .and. flag==0) .or. (n_calls==3 .and. flag==1) .or. (n_calls==5 .and. flag==2)) then
        ...
        call open_files('linmat', &  !intent-in
        ...
        call write_input_output_header(unit_input, unit_output,yaml%lchnk_print,yaml%col_print, &
             'linmat',yaml%nstep_print, yaml%lev_print)
      ...
      ! real(r8), intent(inout) ::  mat(nzcnt)
        ...
        call write_var(unit_input,unit_output,'y',y)
        call write_var(unit_input,unit_output,'rxt',rxt)
        call write_var(unit_input,unit_output,'het_rates',het_rates)
